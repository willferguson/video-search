...
public interface StorageService {
    ...
    /**
     * If the content is available via HTTP somewhere else - EG available in S3 or some HTTP webserver
     * @return
     */
    boolean isExternallyAvailable();


    Single<URL> constructExternalVideoURL(String videoId);

    Single<URL> constructExternalFrameURL(String videoId, String frameId);
