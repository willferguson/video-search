...
import com.github.willferguson.videosearch.persistence.elastic.model.SearchParam;
 ...
 */
@Component
public class FrameSearchRepository {

    private static final Logger logger = LoggerFactory.getLogger(FrameSearchRepository.class);
    ...
    @Autowired
    public FrameSearchRepository(Client client) {
        this.client = client;
    }
